...
<table>
	<tr>
		...
		<td><input style="width:180px;" type="text" class="inputTypeText" id="title" name="title" value="${dto.title}">
    	</td>
	</tr>
	
	<tr>
		<td class="leftrow">작성자</td>
		<td><input type="text" style="width:180px;" class="inputTypeText" id="writer" readonly="readonly" name="writer" value="${dto.writer}">
    	</td>
	</tr>
